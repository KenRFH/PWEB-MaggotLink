...
<body class="bg-[#2d3a2e] h-screen w-screen m-0 p-0 overflow-hidden font-sans">
  <div class="flex h-full w-full">
    ...
    <div class="w-1/2 relative bg-cover bg-center" style="background-image: url('https://source.unsplash.com/featured/?larva,insects');">
    ...
    <div class="w-1/2 bg-[#2d3a2e] flex items-center justify-center">
      <form method="POST" action="{{ route('register.register') }}" class="bg-white w-full max-w-md p-10 rounded-2xl space-y-6">
        @csrf
        ...
        <div class="text-center mt-4">
          <a href="{{ route ('showLogin')}}" class="text-gray-600 text-sm hover:underline">Sudah punya akun?</a>
        </div>
